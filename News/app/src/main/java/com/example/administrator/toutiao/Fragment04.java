...
public class Fragment04 extends android.support.v4.app.Fragment {
    ...
    private String path = "http://v.juhe.cn/toutiao/index?type=redian&key=e76b62dbe5ce78645516fe866dc7058b";
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    xListView.setAdapter(new MyListviewAdpater(getActivity(),data));
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        xListView = (XListView) view.findViewById(R.id.fragment2_list_xlist);
